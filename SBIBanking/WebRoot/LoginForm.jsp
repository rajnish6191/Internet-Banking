...
<span id="clock"></span>
	...
	<font color=red><b><%=request.getParameter("ls") %></b></font><%} %></td></tr>
    ...
    <div align="right"><h3>LoginForm&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h3></div>
          <form action="loginAction.do" method="post" name="register" onsubmit="return validate()">
          ...
          <tr>
             <td><table  border="0" align="right">
               ...
               <tr>
                 <td >&nbsp;</td>
                 <td valign="baseline">
                 <div align="center"><a href="RecoverPassword.jsp"><font color="red">Forgot Password ! !......</a></div></td>
                 <td>&nbsp;</td>
               </tr>
