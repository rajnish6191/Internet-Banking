...
<style type="text/css">
<!--
.style3 {color: #D4F101; font-weight: bold; }
-->
</style>
</head>
...
<span id="clock"></span>
    ...
    <center><h3>Customer Details</h3></center>
          ...
          <form action="SerchBalance.jsp"  name="f" onsubmit="return checkban()">
   <table><tr><td>Account no</td><td><input type="text" name="accountno">
   </td></tr>
<tr><td></td><td>   <input type="submit" name="send" value="Find"/></td></tr>
    ...
    Profile aprofile =new BankAccountDAO().viewAccountNos(accountno); 
     ...
     <td><div align="center"><strong>Opening Date</strong></div></td>
     
     
     <td><div align="center"><strong>Initial Balance</strong></div></td>
     <td><div align="center"><strong>Active Balance</strong></div></td>
     </tr>
     <tr bgcolor="#0C561B"><td><div align="center"><span class="style3"><%=aprofile.getLoginID() %></span></div></td>   
     <td><div align="center"><span class="style3"><%=aprofile.getBankaccountno() %></span></div></td>
      <td><div align="center"><span class="style3"><%=aprofile.getAccountOpeningDate() %></span></div></td>
     <td><div align="center"><span class="style3"><%=aprofile.getAccountInitialBalance() %></span></div></td>
     <td><div align="center"><span class="style3"><%=aprofile.getAccountActivebalance() %></span></div></td>
     </tr></table>
     <%
     }catch(Exception e)
     {
