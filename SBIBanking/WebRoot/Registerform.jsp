  ...
  <form action="customerregisterAction.do" method="post" name="register" onSubmit="return validate()"><fieldset>
                    ...
                    <br />
                      <table border="0" align="center" bgcolor="#8DD79C">
                        <tr>
                          <td class="tiny"><strong><em><strong>Branch Name</strong></em></strong></td>
                        ...
                        <tr>
                          <td class="tiny"><strong><em><strong>Initial Balance </strong></em></strong></td>
...
<td><select name="country">
                        ...
                        <tr>
                          ...
                          <td><input type="text" name="phoneNo" class="textfield"  onBlur="ValidateForm();abc()"/></td>
                        </tr>
                        <tr>
                          <td><em><strong>Email</strong></em></td>
                          <td><input type="text" name="email" class="textfield"  value="" onBlur="isValidEmail(this.value)"/></td>
                        </tr>
