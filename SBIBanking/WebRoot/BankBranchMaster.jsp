...
<span id="clock"></span>
    ...
    <center><h3>Branch Register Form</h3></center>
         
         <%if(request.getParameter("status")!=null){ %>
	<%=request.getParameter("status") %><%} %>
	 
		<form action="bankBranchAction.do" NAME="register" onsubmit="return validateFields()"><table align=center bgcolor="#91DBA0">
			<tr><td><span class="style22">Branch Address :</span></td>
			<td> <textarea name="branchAddr"></textarea> </td></tr>
			<tr><td><span class="style22">Branch EmailId :</span></td>
			<td> <input type=text name="branchEmailId"/></td></tr> 
		 <tr><td><span class="style22">Branch Phone1 : </span></td>
		 <td><input type=text name="branchPhNo1"/> </td></tr>
			<tr><td><span class="style22">Branch Phone2 : </span></td>
			<td><input type=text name="branchPhNo2"/> </td></tr>
			<tr><td><span class="style22">Branch Phone3 : </span></td>
			<td><input type=text name="branchPhNo3"/> </td></tr>
